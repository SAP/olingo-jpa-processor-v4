...
class Term extends CsdlTerm implements Named {
  ...
  /**
   * A non negative integer or floating or variable.
   * </p>
  ...
  public CsdlTerm setScale(final String scaleValue) throws ODataJPAVocabulariesException {
    try {
      final Integer scale = Integer.valueOf(scaleValue);
      return super.setScale(scale);
    } catch (final NumberFormatException e) {
      throw new ODataJPAVocabulariesException(MessageKeys.VARIABLE_NOT_SUPPORTED, e, "Scale");
    }
  }
