...
import org.apache.olingo.jpa.metadata.core.edm.mapper.extention.IntermediateReferenceList.IntermediateReferenceAccess;
...
public class TestIntermediateReferences extends TestMappingRoot {
  ...
  public void checkConvertedToEdmx() throws ODataJPAModelException {
    ...
    assertEquals(serviceDocument.getReferences().size(), 1);
